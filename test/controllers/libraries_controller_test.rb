...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { County_id: @library.County_id, address: @library.address, name: @library.name, telephone: @library.telephone } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { County_id: @library.County_id, address: @library.address, name: @library.name, telephone: @library.telephone } }
